...
class Add_growth_Form(forms.Form):
    growth = forms.DecimalField(label='Wzrost', max_digits=5, decimal_places=1, validators=[MinValueValidator(50), MaxValueValidator(220)]),
...
def __init__(self, *args, **kwargs):
    super(Add_growth_Form, self).__init__(*args, **kwargs)
