...
class Add_pressure_Form(forms.Form):
    shrink = forms.DecimalField(label='Ciśnienie skurczowe', max_digits=5, decimal_places=1, validators=[MinValueValidator(50), MaxValueValidator(200)])
    diastole = forms.DecimalField(label='Ciśnienie rozkurczowe', max_digits=5, decimal_places=1, validators=[MinValueValidator(50), MaxValueValidator(150)])
    pulse = forms.DecimalField(label='Tętno', max_digits=5, decimal_places=1, validators=[MinValueValidator(40), MaxValueValidator(150)])
...
def __init__(self, *args, **kwargs):
    super(Add_pressure_Form, self).__init__(*args, **kwargs)
