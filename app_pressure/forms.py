...
class Add_pressure_Form(forms.Form):
    shrink = forms.DecimalField(label='Ciśnienie skurczowe', max_digits=5, decimal_places=1)
    diastole = forms.DecimalField(label='Ciśnienie rozkurczowe', max_digits=5, decimal_places=1)
